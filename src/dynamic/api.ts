...
const selectEligibleOutcomesFn =
  import("../util/api/selectEligibleOutcomes").then(
    (mod) => mod.selectEligibleOutcomes,
  );
...
const updateBreakthroughStateModule =
  import("../util/api/updateBreakthroughState");
