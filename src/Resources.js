...
export function ResponsiveResources({ resources, influence }) {
  return (
    <div className="flexRow" style={{position: "relative", flexShrink: 0, width: responsivePixels(36), height: responsivePixels(50)}}>
      <div style={{
        color: "#fad54d",
