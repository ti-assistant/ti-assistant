  ...
  return (
    ...
    >
      ...
      >
        ...
        {options.expansions.includes("TWILIGHTS FALL") ? (
          <TFTechList factionId={factionId} tfCardType={tfCardType} />
        ) : (
...
function TFTechList({
  ...
  switch (tfCardType) {
    case "ABILITY":
      innerContent = (
        <>
          <div className={styles.GainCardMenu}>
            <GainAbilitySection
              factionId={factionId}
              gainedAbilities={[]}
              numToGain={1}
      ...
      <div className="flexRow" style={{ zIndex: 1, flexWrap: "wrap" }}>
        {antimatter ? (
          <Toggle
            ...
            info={{
              title: antimatter.name,
              description: (
                <FormattedDescription description={antimatter.description} />
              ),
            }}
        ...
        {wavelength ? (
          <Toggle
            ...
            info={{
              title: wavelength.name,
              description: (
                <FormattedDescription description={wavelength.description} />
              ),
            }}
            style={{ fontSize: rem(12) }}
          >
