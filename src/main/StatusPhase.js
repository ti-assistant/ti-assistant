                  ...
                  <div className={scoredPublics.length === 0 && scoredSecrets.length === 0 ? 'flexRow' : 'flexColumn'} style={{ padding: responsivePixels(8), alignItems: "flex-start" }}>
                      ...
                      : <HoverMenu label="Score Public">
                        <div className="flexColumn" style={{ whiteSpace: "nowrap", gap: responsivePixels(4), padding: responsivePixels(8), alignItems: "stretch" }}>
                          ...
                          {availableObjectives.map((objective) => {
                            return <button key={objective.name} style={{ fontSize: responsivePixels(14) }} onClick={() => scoreObj(card.faction, objective)}>{objective.name}</button>
                          })}
                        </div>
                      </HoverMenu>}
                    {scoredSecrets.length > 0 ?
                      ...
                      : <HoverMenu label="Score Secret">
                        <div className="flexRow" style={{ display: "grid", gridAutoFlow: "column", gridTemplateRows: "repeat(9, auto)", justifyContent: "flex-start", whiteSpace: "nowrap", padding: responsivePixels(8), gap: responsivePixels(4), alignItems: "stretch" }}>
            ...
            <div className='flexRow' style={{ whiteSpace: "nowrap" }}>
              ...
              {(subState.objectives ?? []).length < 1 ?
                <HoverMenu label={`Reveal one Stage ${round > 3 ? "II" : "I"} objective`}>
                  <div className='flexRow largeFont' style={{ gap: responsivePixels(4), whiteSpace: "nowrap", padding: responsivePixels(8), alignItems: "stretch", display: "grid", gridAutoFlow: "column", gridTemplateRows: "repeat(5, auto)", justifyContent: "flex-start" }}>
